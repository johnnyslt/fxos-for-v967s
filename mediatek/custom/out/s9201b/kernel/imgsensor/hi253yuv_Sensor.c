...
{ 
	...
	HI253WriteCmosSensor(0x41, 0x08);//00
	...
	HI253WriteCmosSensor(0x50, 0xa0);//dark3
...
HI253WriteCmosSensor(0x52, 0xb0); //b0
	...
	HI253WriteCmosSensor(0x5d, 0x90);
	...
	HI253WriteCmosSensor(0x63, 0xa4);//80
	...
	HI253WriteCmosSensor(0x69, 0x18);
	HI253WriteCmosSensor(0x6a, 0x07);
	HI253WriteCmosSensor(0x6b, 0x05);
	HI253WriteCmosSensor(0x6c, 0x18);
...
void HI253NightMode(kal_bool Enable)
{
  ...
  else
  {
	...
	else
	{
	  ...
	  HI253WriteCmosSensor(0x88, 0x06); //0x05e800//06
	  HI253WriteCmosSensor(0x89, 0x28); //cc mj
	  HI253WriteCmosSensor(0x8a, 0xc2); //3c mj
                      ...
                      MSDK_SENSOR_CONFIG_STRUCT *sensor_config_data)
{
  ...
  HI253WriteCmosSensor(0x03, 0x10);
  HI253WriteCmosSensor(0x41, 0x10);//00
  HI253SetPage(0x12);
  HI253WriteCmosSensor(0x20, 0x0f);
  HI253WriteCmosSensor(0x21, 0x0f);
...
*/
  ...
  HI253WriteCmosSensor(0x03, 0x10);
  HI253WriteCmosSensor(0x41, 0x00);//00
...
UINT32 HI253GetResolution(MSDK_SENSOR_RESOLUTION_INFO_STRUCT *pSensorResolution)
{
  ...
  pSensorResolution->SensorVideoWidth=HI253_PV_WIDTH;//LINE <> <DATE20121230> <fix video rec hung up> wupingzhou
  pSensorResolution->SensorVideoHeight=HI253_PV_HEIGHT;//LINE <> <DATE20121230> <fix video rec hung up> wupingzhou
...
//  pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_VYUY; // back for 16 SENSOR_OUTPUT_FORMAT_UYVY;
  pSensorInfo->SensorOutputDataFormat=SENSOR_OUTPUT_FORMAT_YUYV; // back for 16 SENSOR_OUTPUT_FORMAT_UYVY; //LINE <> <DATE20121228> <change camera color> wupingzhou
