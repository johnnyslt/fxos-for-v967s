...
CUSTOM_KERNEL_ACCELEROMETER = kxtik1004_auto lis3dh_auto
CUSTOM_KERNEL_ALSPS = ltr559_auto tmd2771_auto
CUSTOM_KERNEL_BATTERY = battery
CUSTOM_KERNEL_CAMERA = camera
CUSTOM_KERNEL_CAM_CAL = hi542otp #dummy_eeprom
...
CUSTOM_KERNEL_IMGSENSOR = hi542_mipi_raw sp0a28_mipi_yuv
CUSTOM_KERNEL_KPD = kpd
CUSTOM_KERNEL_LCM = otm9608_wvga_dsi_cmd  nt35516_qhd_dsi_cmd_success
...
CUSTOM_KERNEL_TOUCHPANEL = S3203 #cy8ctma300 GT818B-fpga
CUSTOM_KERNEL_USB = mt6577
CUSTOM_KERNEL_VIBRATOR = vibrator
CUSTOM_LK_LCM = otm9608_wvga_dsi_cmd  nt35516_qhd_dsi_cmd_success
CUSTOM_MODEM = ztenj89_we_jb2_cu_hspa
CUSTOM_PRELOADER_CUSTOM = custom
CUSTOM_SEC_AUTH_SUPPORT = no
CUSTOM_SEC_SIGNTOOL_SUPPORT = no
CUSTOM_UBOOT_LCM = otm9608_wvga_dsi_cmd  nt35516_qhd_dsi_cmd_success
DEFAULT_INPUT_METHOD = com.cootek.smartinputv5.TouchPalIME
DEFAULT_LATIN_IME_LANGUAGES = en_US fr ru
DISABLE_EARPIECE = no
...
MTK_BT_SUPPORT = yes
MTK_BUILD_VERNO = CU-CN-9B18D-P188F07V1.0.5
MTK_BWC_SUPPORT = yes
...
MTK_FOTA_ENTRY = no   #lixiaojiang close mtk fota,20130227
MTK_FOTA_SUPPORT = no   #lixiaojiang close mtk fota,20130227
...
MTK_PRODUCT_LOCALES = zh_CN en_US zh_TW ldpi xhdpi hdpi mdpi
MTK_QVGA_LANDSCAPE_SUPPORT = no
MTK_RADIOOFF_POWER_OFF_MD = no
MTK_RAT_BALANCING = no
MTK_RAT_WCDMA_PREFERRED = yes
MTK_RCSE_SUPPORT = no
MTK_RELEASE_PACKAGE = rel_customer_basic_mt6589 rel_customer_zte rel_customer_operator_cu
...
MTK_SWIP_AAC = no
MTK_SWIP_VORBIS = yes
MTK_SYSTEM_UPDATE_SUPPORT = no   #lixiaojiang close mtk fota,20130227
MTK_TABLET_DRAM = no
